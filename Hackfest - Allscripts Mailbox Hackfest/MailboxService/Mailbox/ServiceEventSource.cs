...
namespace Mailbox
{
    [EventSource(Name = "ServiceFabricDemo.MailboxService-Mailbox")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        private const int WriteInfoMessageEventId = 7;
        [Event(WriteInfoMessageEventId, Level = EventLevel.Informational, Message = "{0}. Activity ID: {1}", Keywords = Keywords.Requests)]
        public void WriteInfoMessage(string msg, string activityId = "", string exception = "")
        {
            WriteEvent(WriteInfoMessageEventId, msg, activityId, exception);
        }
